...
TODO:
 - [ ] apk build process on github
 - [ ] save a github secret to use as a hash for daily games, package into apk.
 ...
 - [ ] main screen: 3 daily challenges, calendar, logbook, random game, settings?, about exit
 ...
 - [ ] pick a licence
 - [ ] change text buttons to icons (play, pause, undo, redo, share)
 - [ ] nicer buttons
